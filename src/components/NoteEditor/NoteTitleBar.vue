<template>
	<header>
		<title>
			<input type="text" placeholder="" value="Squash/Rebase">
		</title>
		<div>
			<time>03/15/2021 14:00</time>
			<div class="editor-toolbar">
				<a title="Spell checker">
					<i class="fa-globe" title="en">
					</i>en
				</a>
				<a title="Set alarm" href="#">
					<span class="icon-alarm">
					</span>
				</a>
				<a title="Toggle editor layout" href="#">
					<span class="icon-layout " title="">
					</span>
				</a>
				<a title="Note properties" href="#">
